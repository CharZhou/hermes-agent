...
def _submit_fal_request(model: str, arguments: Dict[str, Any]):
    ...
    if managed_gateway is None:
        # Direct FAL calls need the provider client; managed gateway calls only
        # load it when constructing the managed client, avoiding an unnecessary
        # local dependency requirement for gateway-only deployments.
        _load_fal_client()

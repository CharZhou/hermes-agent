...
from agent.model_metadata import (
    MINIMUM_CONTEXT_LENGTH, SMALL_CONTEXT_MINIMUM_LENGTH, get_model_context_length, estimate_messages_tokens_rough, estimate_tokens_rough
)
...
class ContextCompressor(MicroCompactionMixin, ContextEngine):
    ...
    def threshold_tokens(self) -> int:
        if self._threshold_tokens is None:
            ...
            self._threshold_tokens = self._compute_threshold_tokens(
                _ctx, self.threshold_percent, self.max_tokens, minimum_context_length=self.minimum_context_length,
            )
    ...
    def update_model(
        ...
        self.threshold_tokens = self._compute_threshold_tokens(
            context_length, self.threshold_percent, self.max_tokens, minimum_context_length=self.minimum_context_length,
        )
        self._apply_threshold_tokens_cap()

...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from gateway.session_context import scoped_session_platform
        ...
        try:
            ...
            with scoped_session_platform(task_context["platform"]), bind_subagent_parent(self), scoped_runtime_main({}):
                try:
